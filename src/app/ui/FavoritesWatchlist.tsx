    ...
    return (
      <div className="w-full p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div className="flex items-center gap-3 mb-6">
          <Crown className="text-yellow-500 dark:text-yellow-400" size={28} />
    ...
    return (
      <div className="w-full p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center py-16">
          <div className="w-24 h-24 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mb-4 shadow-lg dark:shadow-2xl">
            <Crown className="text-gray-400 dark:text-gray-500" size={40} />
          </div>
          ...
          {onAddFavorite && (
            <button
              ...
              className="flex items-center gap-2 bg-blue-500 dark:bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors shadow-md dark:shadow-lg"
            >
              <Plus size={20} />
